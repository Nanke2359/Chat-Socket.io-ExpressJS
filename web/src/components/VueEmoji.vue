  ...
  methods: {
    ...
    initEmojiPlugin() {
      ...
      Vue.nextTick(() => {
        ...
        this.$el.querySelector(".emoji-picker-container").style.width = `${
          Number(this.width) + 50
        }px`;
      });
    },
  },
